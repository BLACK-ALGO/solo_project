            ...
            <div className="modal">
                ...
                <div className="modal-search">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div class="mt-2">
                        <input type="text" name="emergency-number" id="emergency-number" autoComplete="emergency-number" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                        </div>
                    </div>
                    <div className="sm:col-span-2">
